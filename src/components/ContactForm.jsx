...
return (
  <section className="bg-ElmBg p-4 sm:p-12">
    <Form className="flex flex-col gap-6 text-base sm:text-lg font-bold uppercase" method="post" onSubmit={handleSubmit}>
      <div className="flex-col flex gap-2">
        <label htmlFor="fullname">Full name <span className="text-red-500">*</span></label>
        <input
          className="bg-BtnLightGrey shadow-md block w-full sm:w-2/3 h-12 rounded px-3"
          type="text"
          name="fullname"
          id="fullname"
      ...
      <div className="flex-col flex gap-2">
        ...
        <textarea
          className="bg-BtnLightGrey shadow-md block w-full rounded px-3 py-2 h-40 resize-none"
          id="message"
          name="message"
          rows="5"
      ...
      <div className="flex justify-end">
        <input className="text-ElmBg bg-BtnOrange w-36 h-12 rounded-sm shadow-md block font-thin my-10 cursor-pointer" type="submit" value="Submit" />
      </div>
      {successMessage && (

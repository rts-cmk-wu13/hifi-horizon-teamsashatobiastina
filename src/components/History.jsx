    ...
    <section className="flex flex-col gap-20 px-9  py-12 max-w-8xl mx-auto text-center bg-ElmBg">
      <div className="flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          <p>
            ...
            Upon his retirement, Graham Tiso bought the business and modernized
            the name to HiFi Horizon. Soon thereafter a young enthusiastic Colin
            MacKenzie (left), who was recommended by Linn’s own Ivor Tiefenbrun,
            was employed to manage the shop; with a knack for business and years
            of experience in the hi-fi industry, Colin would later become the
            owner of HiFi Horizon. Today, Struan MacKenzie carries on the legacy
      ...
      <div className="flex flex-col md:flex-row-reverse items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          <p>
            ...
            also offer home demonstrations on selected products. It's our aim to
            get the right product for you. Our experts are on hand to guide you
            through the differences between speakers, amplifiers and sources and
      ...
      <div className="flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          <p>
            ...
            upgrade your system, we offer our part-exchange program. We can
     ...
     We look forward to customising a system to meet your needs. 
          ...
          <p>
            ...
            alone. If you are looking for a product not found in our
            demonstration showrooms or our online site, don’t fret as we have
            access to hundreds of brands. One of our biggest pleasures of
            working in this industry is to see the smile on our customers’ faces
            when they finally hear and see the system of their dreams.
          </p>
        </div>
      </div>
    </section>
